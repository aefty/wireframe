...
module.exports = function(workFlow, procsObj) {
    ...
    var _sync = function(callback) {
        _assembleTask(workFlow[meth][url].sync, function(err, tasks) {
    ...
    var _async = function(callback) {
        _assembleTask(workFlow[meth][url].async, function(err, tasks) {
    ...
    var _assembleTask = function(taskList, callback) {
        ...
        for (var key in taskList) {
            ...
            tasks[module[0] + '-' + module[1]] = procsInst[module[1]];
        }
